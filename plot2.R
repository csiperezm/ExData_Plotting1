## Generating graph for plot 2 for the Course Project 1 in Coursera course Exploratory Data Analysys
...
gen_plot2 <- function(partial_read) {
	...
	plot(partial_read$Global_active_power, type="l", axes=F, ann=T, ylab="Global Active Power (kilowatts)", xlab = "")
...
## Using gen_plot2 function above created to generate the plot
gen_plot2(partial_read)
